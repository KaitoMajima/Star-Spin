...
namespace Tayx.Graphy
{
    ...
    public class GraphyManager : G_Singleton<GraphyManager>
    {
        ...
        {
            return m_keyboard[key].wasPressedThisFrame;
        }

        private bool CheckFor2KeyPress(Key key1, Key key2)
        {
            return m_keyboard[key1].wasPressedThisFrame && m_keyboard[key2].wasPressedThisFrame
                || m_keyboard[key2].wasPressedThisFrame && m_keyboard[key1].wasPressedThisFrame;
        }

        private bool CheckFor3KeyPress(Key key1, Key key2, Key key3)
        {
            return m_keyboard[key1].wasPressedThisFrame && m_keyboard[key2].wasPressedThisFrame && m_keyboard[key3].wasPressedThisFrame
                || m_keyboard[key2].wasPressedThisFrame && m_keyboard[key1].wasPressedThisFrame && m_keyboard[key3].wasPressedThisFrame
                || m_keyboard[key3].wasPressedThisFrame && m_keyboard[key1].wasPressedThisFrame && m_keyboard[key2].wasPressedThisFrame;
        }
